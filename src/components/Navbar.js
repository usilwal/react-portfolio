        ...
        <header className="bg-gray-700">
            <div className="container mx-auto flex justify-between">
                <nav className="flex">
                    ...
                    <NavLink to="/posts" activeClassName="text-gray-100 bg-gray-700"
                    className="inline-flex items-center py-3 px-3 my-6 rounded text-gray-200 hover:text-green-400">
                        Posts
                    </NavLink>
                    <NavLink to="/projects" activeClassName="text-gray-100 bg-gray-700"
                    className="inline-flex items-center py-3 px-3 my-6 rounded text-gray-200 hover:text-green-400">
                        Projects
                    </NavLink>
                    <NavLink to="/about" activeClassName="text-gray-100 bg-gray-700"
                    className="inline-flex items-center py-3 px-3 my-6 rounded text-gray-200 hover:text-green-400">
                        About
                    </NavLink>
                </nav>
